...
class DatabaseService {
    ...
    async initialize(dbPath = './data/ico.db') {
        this.dbPath = dbPath;
    ...
    async insertDataVersion(version) {
        if (!this.db)
            throw new Error('Database not initialized');
